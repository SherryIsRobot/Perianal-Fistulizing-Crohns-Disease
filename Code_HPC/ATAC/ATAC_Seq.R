...
cnt <- read.delim("/work/users/w/x/wxueyao/Furey_Lab/ATAC/PLEXUS_RUVg_RF_01242025_normalized_counts_k7_A.tsv", header=T, check.names = FALSE)
met <- read.delim("/work/users/w/x/wxueyao/Furey_Lab/ATAC/plexus_atac_metadata_03112024.tsv", header=T)
